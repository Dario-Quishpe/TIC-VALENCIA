...
# Parámetros para el proceso de clusterización de Matern
kappa <- 10  # Intensidad del proceso de los centros de los clusters
r <- 0.05    # Radio de los clusters
mu <- 50     # Número medio de puntos por cluster

# Generar el proceso puntual con clusters usando rMatClust
set.seed(42) # Para reproducibilidad
point_pattern <- rMatClust(kappa, r, mu, win=window)

# Redimensionar para tener exactamente 500 puntos
while (npoints(point_pattern) != 500) {
  point_pattern <- rMatClust(kappa, r, mu, win=window)
}

# Plotea el proceso puntual
plot(point_pattern, main="Proceso Puntual con Clusters en un Cuadrado")

# Mostrar número de puntos generados
