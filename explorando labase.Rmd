...
dim(puntos_grafica)
dim(puntos)
ggplot()+geom_sf(data = ventana,color="black",size=5)+geom_sf(data = y,color="blue")+geom_sf(data = puntos_grafica,aes(),size=0.1,color="yellow")+scale_x_continuous()+theme(plot.margin = margin(1, 1, 1, 1, "mm"),
        panel.spacing = unit(1, "lines"))
ggplot()+geom_sf(data = ventana,color="black",size=2)+geom_sf(data = y,color="blue")+geom_sf(data = puntos_grafica,aes(),size=0.1,color="yellow")+facet_wrap(~crime_type,nrow=1,ncol=4)+
...
horadeldia<-base |> group_by(crime_hour) |> summarise(Observaciones=n()) |> arrange(crime_hour)
